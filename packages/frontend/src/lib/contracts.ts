 ...
 * 
 * Contract addresses and ABIs for the Mini-DEX system.
 */

import { Address } from 'viem';

// Contract addresses (will be set via environment variables in production)
export const GEMINI_TOKEN_ADDRESS = (process.env.NEXT_PUBLIC_GEMINI_TOKEN_ADDRESS || 
  '0x0000000000000000000000000000000000000000') as Address;

export const SIMPLE_POOL_ADDRESS = (process.env.NEXT_PUBLIC_SIMPLE_POOL_ADDRESS || 
  '0x0000000000000000000000000000000000000000') as Address;
